...
class ProductService {
    ...
    async addProduct(productInfo) {
      // 객체 destructuring
      const { name, price, category, quantity, img, size, brandName, keyword, shortdescription, detaildescription } = productInfo;
      ...
      const newProductInfo = { name, price, category, quantity, img, size, brandName, keyword, shortdescription, detaildescription }
